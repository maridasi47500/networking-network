...
const LeafIcon = L.Icon.extend({
   ...
   function onMapClick(e) {
           var mylat = document.getElementById("somefieldpast_current_villagelat");
           var mylon = document.getElementById("somefieldpast_current_villagelon");
	   ...
	   if (document.getElementById("lat") && document.getElementById("lon")){
	       ...
	       console.log(e.latlng);
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      $(document).ready(function(){
                                                                                                                                                                                                              ...
                                                                                                                                                                                                              initMap();
                                              if (window.location.pathname==="/" || window.location.pathname==="/add_one_past_current_village"){
						      $.ajax({
...
success:function(data){
    ...
    somefieldpast_current_villagelat.value=data.latitude;
    somefieldpast_current_villagelon.value=data.longitude;
    if (String(data.region) !== "undefined"){
